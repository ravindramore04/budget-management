	...
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#666666" >
      <tr bgcolor="#FFFFFF"> 
        <td height="20" colspan="5" > <div align="left" class="titles"><strong>Expense 
            Head-<%=(String)hmFin.get("strName")%> </strong></div></td>
         <Td align="right">Page No. <%=PG%></td>
      </tr>
      <tr>
	    <td width="9%" height="20" align="center" bgcolor="#FFFFFF" class="link"><strong>Vou No</strong></td> 
        <td width="15%" height="20" align="center" bgcolor="#FFFFFF" class="link"><strong>Date</strong></td>
        ...
        <td width="19%" height="20" align="left" bgcolor="#FFFFFF" class="link"> 
      ...
      if(K>20)
      	{	
			...
			<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#666666" >
		      ...
		      <tr>
			    <td width="8%" height="20" align="center" bgcolor="#FFFFFF" class="link"><strong>Vou No</strong></td> 
		        <td width="14%" height="20" align="center" bgcolor="#FFFFFF" class="link"><strong>Date</strong></td>
		        <td width="14%" height="20" align="left" bgcolor="#FFFFFF" class="link"> 
		          <div align="center"><strong>Allocation</strong></div></td>
		        <td width="28%" height="20" align="left" bgcolor="#FFFFFF" class="link"> 
		          <div align="center"><strong>Receiver Name</strong></div></td>
		        <td width="15%" height="20" align="left" bgcolor="#FFFFFF" class="link"> 
		          <div align="center"><strong>Expense Made</strong></div></td>
		        <td width="21%" height="20" align="left" bgcolor="#FFFFFF" class="link"> 
		          <div align="center"><strong>Balance</strong></div></td>
      			</tr
      //*************************************************************>
   <%   			
	  ...
	  if(hmVot!=null && hmVot.size()>0)
	  {
	    ...
	    for(int j=0;j<hmVot.size();j++)
		{
			...
			strVoucherNo = (String)hmVoct.get("VouNo");
	  ...
	  %>
      <tr bgcolor="">
	    <td height="40" align="center" bgcolor="#FFFFFF" class="link"><%=strVoucherNo%></td> 
        <td height="40" align="center" bgcolor="#FFFFFF" class="link"><%=Date%></td>
      ...
      <tr class="link" >
        ...
        <td height="40" align="Right" bgcolor="#FFFFFF"><strong><%=bal%></strong></td>
      </tr>
    </table>
