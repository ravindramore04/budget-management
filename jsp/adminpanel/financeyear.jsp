...
function navigation(code){
    ...
    document.UserList.action = "<%=strPath+"OpenNewYear.do"%>";
...
alert("---->"+code);
	...
	alert(""+document.UserList.opr.value);
    document.UserList.submit();
}
...
<form name="UserList" method="post" action="#">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" >
		...
		<td width="100%" align="center" class="titles" height="20"> Finacial Year</td>
            ...
            if(hmData!=null && hmData.size()>0){
                for(int indx=0;indx<hmData.size();indx++){
                    ...
                    if(hmt!=null && hmt.size()>0){
                        String ID = (String)hmt.get("ID");
                        String F_Year = (String)hmt.get("F_Year");
			...
			<tr bgcolor="<%=indx%2==0?strCol2:strCol1%>">
				...
				<td align="left" class="link" height="20">
					<!--<a href="#" onClick="setAction(2,<%=ID%>)"-->  <%=F_Year%>-<%=T_Year%>
				</td>
	    ...
	    <tr> 
	      <td colspan="4" valign="top" height="20" align="center">
	          <table width="50%">
		      <tr> 
		    	<td align="center"> <input type="button" name="btn1" value="Add new" accesskey="N" onClick="setAction(1,0)" class="PPRSbmtBtn"> 
		    	</td>
		    
		    	<td> <input type="button" name="btn2" value="   Close   " accesskey="C" onClick="setAction(4,0)" class="PPRSbmtBtn"> 
		    	</td>
		      </tr>
		  </table>
	      </td>
