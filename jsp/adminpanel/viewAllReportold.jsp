	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" >
      ...
      <% for(int i=0;i<Allo.size();i++)
	  {
		...
		%>
		        ...
		        <td width="20%" align="center" height="20"><a href="javascript:setAction(1,<%=(String)hmt.get("HeadId")%>)"><%=(String)hmt.get("strName")%></a></td>
		        
        <td width="15%" align="center" height="20"><%=(String)hmt.get("strAccNo")%></td>
		        
        <td width="25%" align="center" height="20"><%=(String)hmt.get("BSUM")%></td>
        ...
        <td width="25%" align="center" height="20"><%=(String)hmt.get("BSUM")%></td>
		        <td width="20%" align="center" height="20"> 0.00</td>
				 <td width="20%" align="center" height="20"> 0.00</td>
		        <td width="15%" align="center" height="20"><%=(String)hmt.get("BSUM")%></td>
			</tr>		
		<%
		}
	}
