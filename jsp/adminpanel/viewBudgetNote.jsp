...
<form name="HeadList" method="post" action="#">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" >
      <tr bgcolor="#3333FF" class="titles"> 
        <td height="20"  colspan="5"> <div align="center"><U>BUDGET NOTE-2007-2008</U></div></td>
      </tr>
      <tr> 
      ...
      <tr> 
		...
		%>
          <%//=Double.parseDouble((String)hmAllo.get("VSUM"))%>
          </strong></td>
        <td>&nbsp;</td>
		<!-- +Double.parseDouble((String)hmAllo.get("TSUM")) -->
      ...
      <tr> 
		...
		if (bal!=null)
		{
			double result = Double.parseDouble(bal)-(Double.parseDouble(vou)+Double.parseDouble(POSUM));//+Double.parseDouble(tds));
