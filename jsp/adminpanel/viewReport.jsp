...
<form name="HeadList" method="post" action="#">
	...
	<table width="100%" border="1" cellspacing="1" cellpadding="1" align="center" >
      ...
      <tr bgcolor="#E6F3FF">
	    <td width="8%" height="20" align="center" class="link">Vou No</td>  
        <td width="14%" height="20" align="center" class="link">Date</td>
        <td width="10%" height="20" align="left" class="link"><div align="center">Allocation</div></td>
        <td width="24%" height="20" align="left" class="link"><div align="center">Receiver Name</div></td>
        <td width="10%" height="20" align="left" class="link"><div align="center">Expense 
            Made BY Voucher</div></td>
		<td width="9%" height="20" align="left" class="link"><div align="center">Expense 
            Made BY PO No</div></td>
        <td width="25%" height="20" align="left" class="link"><div align="center">Balance</div></td>
      </tr>
      <%
	  ...
	  if(hmVot!=null && hmVot.size()>0)
	  {
	    ...
	    for(int j=0;j<hmVot.size();j++)
		{
			...
			System.out.println("strVoucherNo"+strVoucherNo); 
	  %>
      <tr bgcolor="">
	    <td align="center" height="20" class="link" bgcolor="#CCCCFF"><%=strVoucherNo%></td> 
