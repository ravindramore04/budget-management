   ...
   <input type="hidden" name="page" value="VoucherList">
	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" >
		...
		<tr> 
			...
			<td width="20%" align="left">&nbsp;</td>
			<td width="20%" aign="left">&nbsp;</td>
			<td width="40%" align="right" valign="bottom"><%=strVoucherNo%></td>
		</tr>
		<tr> 
			<td colspan=4>&nbsp;</td>
		</tr>
		<tr> 
			...
			<td width="20%" align="left">&nbsp;</td>
			<td width="20%" aign="left">&nbsp;</td>
			<td width="40%" align="right" valign="bottom"><font face="Georgia, Times, serif" size="3"><%=Date%></font></td>
		</tr>
		<tr> 
			<td colspan=4>&nbsp;</td>
		</tr>
...
<!-- printing voucher# and ate table finishes  -->

	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="right"><!-- bgcolor="#cccccc" -->
		<tr> 
			<td width="50%" align="left" valign="bottom" colspan="3"><font face="Georgia, Times, serif" size="3">
			   			<%
			...
			<td width="50%" align="left" colspan="2" valign="bottom"><font face="Georgia, Times, serif" size="3"><%=strAccountNo%></font></td>
		...
		<tr> 
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
			<td width="20%" align="right" valign="bottom"><br>Amount</td>
			<td width="20%" align="right" valign="bottom"><font face="Georgia, Times, serif" size="3"><%=dblAmount+dblTds%></font></td>
			<td width="20%" align="center" valign="bottom"><font face="Georgia, Times, serif" size="3">&nbsp;</font></td>
		</tr>
		<tr> 
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
			<td width="20%" align="right" valign="bottom"><br>TDS</td>
			<td width="20%" align="right" valign="bottom"><font face="Georgia, Times, serif" size="3"><%=dblTds%></font></td> 
			<td width="20%" align="center" valign="bottom"><font face="Georgia, Times, serif" size="3">&nbsp;</font></td>
		</tr>
		<tr> 
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
			<td width="20%" align="left">&nbsp;</td>
			<td width="20%" align="right" valign="top"><font face="Georgia, Times, serif" size="3"><br><%=dblAmount%></font></td>
			<td width="20%" align="center" valign="bottom"><font face="Georgia, Times, serif" size="3">&nbsp;</font></td>
		</tr>
		</table>
<!-  amount printing table finishes -->

	<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center"><!-- bgcolor="#cccccc" -->
		<tr> 
			<td width="50%" align="left">&nbsp;</td>
			<td width="50%" align="left" colspan=3><font face="Georgia, Times, serif" size="3">
			<Script language="JavaScript">
		...
		<tr> 
			<td align="left">&nbsp;</td>
			<td align="left" colspan=3 valign="bottom"><font face="Georgia, Times, serif" size="3"><%=strToAcc%></font></td>
		</tr>
		<tr> 
			<td colspan=4>&nbsp;</td>
		</tr>
		...
		<tr> 
			<td align="left">&nbsp;</td>
			<td align="left" colspan=3 valign="bottom"><%=bMode.equals("0")?"Cash": "Cheque ("+strCheque+")"%></td>
		</tr>

		<tr> 
			<td align="left">&nbsp;</td>
			<td align="left" colspan=3 valign="bottom"><%=strReceiverNm%></td>
		</tr>
	</table>

<!-- amount in words,TDS Recevier name printing table finishes -->
	</form>
</td>
</body>
</html>