...
function navigation(code){
    ...
    document.VoucherList.action = "<%=strPath+"VoucherPrint.do"%>";
...
function setAction(code,id){
    ...
    switch(code){
        case 1:
            document.VoucherList.action = "<%=strPath+"PrintVoucher.do"%>";
            break;
        case 2:
            document.VoucherList.action = "<%=strPath+"PrintVoucher.do"%>";
            break;
...
<form name="VoucherList" method="get" action="#">
		...
		<td width="20%" align="center" class="titles" height="20">
			...
			<tr bgcolor="<%=indx%2==0?strCol2:strCol1%>">
				...
				<td align="left" class="link" height="20">
					<a href="javascript:setAction(2,<%=strId%>)"><%=dd_mm_yyyy%></a>
				</td>
				<td align="left" class="link" height="20">
					<%=strName%>
				</td>
