...
function handleEnter(fieldname,frm){
   ...
   <input type="hidden" name="txtDt" value="">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" >
      ...
      <tr> 
        <td width="200" class="innertitle" align="left">&nbsp;</td>
      ...
      <tr> 
        <td width="200" class="innertitle" align="left">Head</td>
      ...
      <tr> 
        <td width="100" class="innertitle" align="left">PO NO
		<Input type = "hidden" Name= "txtsession">
		</td>
        <td   width="350" align="left"> <div align="right"> 
            
			<SELECT NAME ="session">
				<option value="" Selected><%=upstrPONo%></option>
			</select>
			<!--<input type="text" name="txtAccNo" size="20" class="formfield" value="<%//=strAccountNo%>"  onKeyPress="handleEnter('txtNetAmt','BudgetHead')">-->
          </div></td>
      ...
      <tr> 
        <td colspan="2" align="center" > <table width="68%" border="1" cellspacing="1" cellpadding="1" align="Right" bgcolor="<%=strCol2%>">
            <tr> 
