...
/**
 * Created by morer on 22-01-2026.
 */

public class AllDepartmentHandler extends org.apache.struts.action.Action
{
                                 ...
                                 HttpServletResponse response) throws RuntimeException,Exception
    {
        ...
        try{
            ...
            sop("strPage_num>>"+strPage_num);
            sop("strNavOpr>>"+strNavOpr);
