...
public class AllHeadHandler extends org.apache.struts.action.Action
{
	...
	HttpServletResponse response) throws RuntimeException,Exception
	{
            ...
            try{
                    ...
                    if(daf!=null){
                        ...
                        System.out.println("Indside The if loop  strNavOpr"+strNavOpr+" strPage_num --> "+strPage_num  );
                    }
                      System.out.println("Indside The if loop "+strNavOpr+" strPage_num --> "+strPage_num  );
                    ...
                    if(nPage<=nTotalPage){
                        ...
                        cvdal.setSQL("openAllHeadWL", vec);
