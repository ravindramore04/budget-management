...
public class AllUserHandler extends org.apache.struts.action.Action
{
	...
	HttpServletResponse response) throws RuntimeException,Exception
	{
            ...
            try{
                    ...
                    if(nPage<=nTotalPage){
                        ...
                        cvdal.setSQL("openAllUserWL", vec);
				...
				hmErr.put("no","138530");
				hmErr.put("Source","AllUserHandler");
				hmErr.put("err",err);
