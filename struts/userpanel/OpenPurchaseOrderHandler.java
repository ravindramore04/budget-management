...
public class OpenPurchaseOrderHandler extends org.apache.struts.action.Action
{
	...
	HttpServletResponse response) throws RuntimeException,Exception
	{
            ...
            try{
                    ...
                    vec.clear();
                    cvdal.setSQL("openAllPurchaseOrder", vec);
                    ...
                    if(nPage<=nTotalPage){
                        ...
                        cvdal.setSQL("openAllPurchaseOrderWL", vec);
				...
				hmErr.put("no","138530");
				hmErr.put("Source","OpenPurchaseOrderHandler");
				hmErr.put("err",err);
