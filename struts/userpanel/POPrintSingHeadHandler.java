...
public class POPrintSingHeadHandler extends org.apache.struts.action.Action
{
	...
	HttpServletResponse response) throws RuntimeException,Exception
	{
            ...
            try{
                    ...
                    strId=(String)request.getParameter("txtHeadId");
					vec.clear();
					...
					if(vec1!=null && vec1.size()>0){
						...
						String Headid=(String)hmFinal.get("HeadId");
						sop("---Headid-------"+Headid);


						vec1.clear();
						vec1.addElement(Headid);
						sop("---Headid-------"+Headid);
						...
						if(vec1!=null && vec1.size()>0){
							...
							if(vec!=null && vec.size()>0 )
							{
								...
								//{
								HashMap HMTT =(HashMap)vec.elementAt(0);
								sop("=---------HMTT------ravi------------------"+HMTT);
								hmFinal.put("rr",HMTT);
				...
				hmErr.put("no","138530");
				hmErr.put("Source","PrintSingHeadHandler");
				hmErr.put("err",err);
